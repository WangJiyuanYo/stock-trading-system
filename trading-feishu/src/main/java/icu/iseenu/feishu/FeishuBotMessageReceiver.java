...
public class FeishuBotMessageReceiver {
    ...
    @Value("${feishu.app-id:}")  // 添加默认值为空字符串
    private String appId; // app_id, required, 应用ID

    @Value("${feishu.app-secret:}")  // 添加默认值为空字符串
        ...
        EventDispatcher eventHandler = EventDispatcher.newBuilder(appId, appSecret)
                .onP2MessageReceiveV1(new ImService.P2MessageReceiveV1Handler() {
                    ...
                    public void handle(P2MessageReceiveV1 event) throws Exception {
                        ...
                        try {
                            // TODO: 等待 FeishuService.resolveEvent 实现后启用
                            ...
                            log.info("Message received but processing is temporarily disabled");
                        } catch (Exception e) {
