package icu.iseenu.service.notification.channel;

import icu.iseenu.config.properties.NotificationProperties;
 ...
 */
@Component
public class ServerChanChannel implements NotificationChannel {
    private static final Logger log = LoggerFactory.getLogger(ServerChanChannel.class);
    ...
    public ServerChanChannel(NotificationProperties notificationProperties, WebClient.Builder webClientBuilder) {
